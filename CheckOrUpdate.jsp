<%-- 
    Document   : CheckOrUpdate
    Created on : Feb 1, 2015, 6:55:11 PM
    Author     : BGiwrgos
--%>
                ...
                <%
                    ...
                    if(status == true){
                        try 
                        {
                            ...
                            ps=con.prepareStatement("update neworder4 set ProdCode=?,productname=?,tax=?,minq=?,orderq=?,discount=?,netcost=?,amount=?,paymode=? where id =?");	   
	 	            ps.setDouble(10,orderid);
                            ...
                            if(update>0){
                                ...
                                out.print("your order has been updated");
                                request.setAttribute("order","your order has been updated");
                                %>			
