<%-- 
    Document   : admin
    Created on : Jan 19, 2015, 2:56:40 PM
    Author     : BGiwrgos
--%>
...
<html>
    ...
    <table width="960" border="0" cellspacing="10" cellpadding="0" align="center">
        <tr align="justify">
            ...
            <td valign="top">
                <%if(request.getAttribute("adminWrong")!=null)
			{
			out.print("<div>");
			out.print("<font color='blue'><font size='4'>"+request.getAttribute("adminWrong")+"");
			
			out.print("</div>"); 
			}
			
                %>
                <form name=F1 onSubmit="return dil(this)" action="adminCheck.jsp" >
