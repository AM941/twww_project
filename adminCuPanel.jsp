<%-- 
    Document   : adminCuPanel
    Created on : Feb 1, 2015, 2:40:16 AM
    Author     : BGiwrgos
--%>
...
<html>
    ...
    <table width="960" border="0" cellspacing="5" cellpadding="0" align="center">
        <%if(request.getAttribute("deleted")!=null){
            out.print("<font color='blue'><font size='5'><h5>"+request.getAttribute("deleted")+"</h5>");
        }		
	%>
        <tr align="justify">
            ...
            <%
                ...
                try {
                    ps = con.prepareStatement("Select * from newcust4");
                    ResultSet rs=ps.executeQuery();
			
                    out.print("<li><a href='CuDelete.jsp'>Delete</a></li>");
